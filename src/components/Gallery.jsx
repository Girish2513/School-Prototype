  ...
  return (
    <section className="gallery-section">
      <div className="gallery-header">
        ...
        <p>
          Catch a sneak peek of campus life! 🎓
          <br />
          Where every picture tells a story of learning, laughter, and growth.
        </p>
      </div>
      ...
      <div className="gallery-content">
        <div id="galleryTrack" className="gallery-track">
          ...
          <div className="gallery-item">
            <img src="/images/school-ground.jpeg" alt="Activity" />
          </div>
          <div className="gallery-item">
            <img src="/images/flag-hoisting.jpeg" alt="Classroom" />
          </div>
          <div className="gallery-item">
            <img src="/images/event.jpeg" alt="Event" />
          </div>
          <div className="gallery-item">
            <img src="/images/school-front-side.jpeg" alt="Group Photo" />
          </div>
        </div>
      </div>
